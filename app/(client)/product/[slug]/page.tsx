...
import FavourateButton from "@/components/FavourateButton";
    ...
    <Container className="flex flex-col md:flex-row gap-10 py-10">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-5">
        <div className="space-y-1">
          ...
          <div className="border-t border-gray-200 py-5 border-b space-y-2">
            <PriceView
              price={product?.price}
          ...
          <div className="flex items-center  gap-2.5 lg:gap-3.5">
            <AddToCartButton className="px-10" product={product} />
            <FavourateButton showProduct={true} product={product} />
          </div>
          <ProductCharacteristics product={product} />
          <div className=" flex flex-wrap items-center text-xs justify-between gap-2.5 border-b border-b-gray-200 py-5 -mt-2">
            ...
            <div className="border border-lightColor/25 p-3 flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 underline underline-offset-2">
                  {" "}
                  Enter Your code for Delivery Availabity
                </p>
              </div>
            </div>
